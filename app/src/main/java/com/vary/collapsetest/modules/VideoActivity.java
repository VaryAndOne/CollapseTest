...
public class VideoActivity extends AppCompatActivity implements ManifestFetcher.ManifestCallback<HlsPlaylist>,ExoPlayer.Listener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video_url = "http://172.27.35.1/hls/output.m3u8";
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
        ...
        if (manifest instanceof HlsPlaylist){
            HlsMediaPlaylist masterPlaylist = (HlsMediaPlaylist) manifest;
//            haveSubtitles = masterPlaylist.subtitles.isEmpty();
    ...
    private boolean requestFocus() {
        return  AudioManager.AUDIOFOCUS_REQUEST_GRANTED == am.requestAudioFocus(VideoActivity.this,AudioManager.STREAM_MUSIC,AudioManager.AUDIOFOCUS_GAIN);
    }
